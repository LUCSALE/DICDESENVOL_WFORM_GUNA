...
namespace dicdesenvol
{
    ...
    {
        public FrmUsabilidadeImp(Guna2DataGridView DstWork)
        {
            InitializeComponent();
        ...
        private void ImpImpressao()
        {
            ...
            page.Canvas.DrawString("Usabilidade", font1, brush1, page.Canvas.ClientSize.Width / 2, y, format1);

            y = y + font1.MeasureString("Usabilidade", format1).Height;
